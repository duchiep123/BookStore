...
public class FilterDispatcher implements Filter {
    ...
    private final String SHOPPING = "shoppingpage.jsp";
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (resource.trim().length() > 0) {
                ...
                } else if (resource.equals("removeBook") || resource.equals("updateBook") || resource.equals("insertNewBook") || resource.equals("getAllUser")) {
                ...
                } else if (resource.contains(".jsp")) { // vo trang create 
                    CategoryDAO daoCategory = new CategoryDAO();
                    Vector<CategoryDTO> listCategory = daoCategory.getAllCategory();
                    request.setAttribute("LISTCATEGORY", listCategory);
                    url = resource;
                } else if (resource.equals("buyBook") || resource.equals("confirmBook") || resource.equals("removeBookInCart") || resource.equals("updateQuantity") ||resource.equals("checkDiscount") || resource.equals("showHistoryOrder")) {
